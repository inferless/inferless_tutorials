...
- By using the vLLM, you can expect an average latency of average inference time of 4.80sec, generating an average of 106.48 tokens/sec and an average cold start time of 10.49sec using an A100 GPU(80GB).
