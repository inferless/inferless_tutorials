...
- By using the Transformers, you can expect an average latency of 90ms for single-step image generation and an average cold start time of 8.03sec using an A100 GPU(80GB).
